...
```
Перемикач «Дозволити вхід тільки з локальної мережі» можна ввімкнути. ' Натисніть Створити. ' 
Тепер відкрийте конфігурацію аддона UZ Train Delay Monitor і вкажіть там цей логін та пароль: YAML
